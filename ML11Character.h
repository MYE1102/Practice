...
#include "Pickup.h"
#include "ML11Character.generated.h"

class UInputComponent;

UCLASS(config=Game)
class AML11Character : public ACharacter
{
	GENERATED_BODY()
...
public:
	AML11Character(const FObjectInitializer& ObjectInitializer);
	...
	TSubclassOf<class AML11Projectile> ProjectileClass;
